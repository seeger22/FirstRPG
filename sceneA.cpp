...
void sceneA::initialise()
{
    cutscene = true;
    next_scene_id = 1; //scene_b, enter


    GLuint map_texture_id = Utility::load_texture("assets/tileset.png");
    this->state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, sceneA_DATA, map_texture_id, 1.0f, 4, 1);
