...
void sceneI::render(ShaderProgram* program)
{
    ...
    switch (decision){
    case 1:
        Utility::draw_text(program, "1500", 0.75f, -0.45f, glm::vec3(4.5f, -5.0f, 0.0f));
        break;
    case 2:
        Utility::draw_text(program, "~", 0.75f, -0.45f, glm::vec3(4.5f, -5.0f, 0.0f));
        break;
    case 3:
        Utility::draw_text(program, "3000", 0.75f, -0.45f, glm::vec3(4.5f, -5.0f, 0.0f));
        break;
    case 0:
        Utility::draw_text(program, "0", 0.75f, -0.45f, glm::vec3(4.5f, -5.0f, 0.0f));
        break;
    }
    // Utility::draw_text(program, "y to replay", 0.75f, -0.45f, glm::vec3(4.5f, -5.5f, 0.0f));
    // ADDITION: add replay but this might be hard using these scripts
}